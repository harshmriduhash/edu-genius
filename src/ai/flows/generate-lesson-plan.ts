...
const GenerateLessonPlanInputSchema = z.object({
  ...
  duration: z
    .string()
    .describe("The total duration of the lesson (e.g., 45 minutes)."),
...
const LessonModuleSchema = z.object({
  ...
  activities: z
    .array(z.string())
    .describe("A list of activities for this module."),
});
...
const GenerateLessonPlanOutputSchema = z.object({
  ...
  assessment: z
    .string()
    .describe("A suggestion for how to assess student learning."),
});
